(function (global) {
  ...
  const messages = {
    "zh-CN": {
      ...
      toggleNav: "展开导航", collapseNav: "收起导航", toggleSidebar: "折叠侧栏", expandSidebar: "展开侧栏",
      notificationsUnavailable: "通知稍后开放",
      ...
      stylePresetLabel: "页面风格", styleSocial: "现代社交", styleMinimal: "极简阅读",
      styleTechnical: "技术文档", styleNewsletter: "专栏 Newsletter", styleCover: "卡片封面",
      ...
      accountDetails: "账号详情", accountProvider: "登录提供商", accountRole: "角色", accountLocale: "语言偏好",
      accountEmailMissing: "未提供邮箱", roleAdmin: "管理员", roleUser: "普通用户", signInRequired: "请先登录后继续。",
      ...
      confirmDeleteArticle: "确定永久删除这篇文章吗？", deleteConfirmPrompt: "再次点击删除文章以确认永久删除。",
    ...
    "en-US": {
      ...
      toggleNav: "Expand navigation", collapseNav: "Collapse navigation", toggleSidebar: "Collapse sidebar", expandSidebar: "Expand sidebar",
      notificationsUnavailable: "Notifications coming later",
      ...
      stylePresetLabel: "Page style", styleSocial: "Modern social", styleMinimal: "Minimal reading",
      styleTechnical: "Technical docs", styleNewsletter: "Newsletter", styleCover: "Cover card",
      ...
      accountDetails: "Account details", accountProvider: "Provider", accountRole: "Role", accountLocale: "Language",
      accountEmailMissing: "No email provided", roleAdmin: "admin", roleUser: "user", signInRequired: "Please sign in to continue.",
      ...
      confirmDeleteArticle: "Permanently delete this article?", deleteConfirmPrompt: "Click Delete again to permanently delete this article.",
